...
function renderBossBulletShape(bullet, color) {
    ...
    switch (bullet.pattern) {
        ...
        case 'butterfly_shot':
            ...
            ctx.beginPath();
            // 몸통
            ctx.ellipse(0, 0, size * 0.1, size * 0.6, 0, 0, Math.PI * 2);
            ctx.fill();
            // 날개들
            ctx.beginPath();
            ctx.ellipse(-size * 0.3, -size * 0.2, size * 0.3, size * 0.2, -Math.PI/6, 0, Math.PI * 2);
            ctx.fill();
            ctx.beginPath();
            ctx.ellipse(size * 0.3, -size * 0.2, size * 0.3, size * 0.2, Math.PI/6, 0, Math.PI * 2);
            ctx.fill();
            ctx.beginPath();
            ctx.ellipse(-size * 0.2, size * 0.1, size * 0.2, size * 0.15, -Math.PI/4, 0, Math.PI * 2);
            ctx.fill();
            ctx.beginPath();
            ctx.ellipse(size * 0.2, size * 0.1, size * 0.2, size * 0.15, Math.PI/4, 0, Math.PI * 2);
            ctx.fill();
